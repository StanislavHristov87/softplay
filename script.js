...
function initDarkMode() {
    ...
    const darkModeToggles = document.querySelectorAll('#dark-mode-toggle, #dark-mode-toggle-mobile, #dark-mode-toggle-mobile-menu');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMobileLangFlag() {
        const currentLang = localStorage.getItem('language') || 'bg';
        const flagImg = document.getElementById('mobile-current-lang-flag');
        if (flagImg) {
            flagImg.src = currentLang === 'bg' ? 'icons/Bulgaria.png' : 'icons/United Kingdom.png';
            flagImg.alt = currentLang === 'bg' ? 'Български език' : 'English';
        }
    }
    ...
    // Initialize mobile language flag
    updateMobileLangFlag();
    ...
    document.addEventListener('click', function(e) {
        ...
        if (dropdown && toggle && !dropdown.contains(e.target) && !toggle.contains(e.target)) {
            window.closeMobileLangDropdown();
        }
    });
    
    // Update flag when language changes (override setLanguage to update flag)
